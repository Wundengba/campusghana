...
export const STUDENTS_DATA = [
  { id:1, full_name:"Kwame Asante", index:"2024001", class:"", region:"Ashanti", aggregate:8, status:"confirmed" },
  { id:2, full_name:"Abena Mensah", index:"2024002", class:"", region:"Greater Accra", aggregate:12, status:"pending" },
  { id:3, full_name:"Kofi Boateng", index:"2024003", class:"", region:"Central", aggregate:6, status:"confirmed" },
  { id:4, full_name:"Akosua Frimpong", index:"2024004", class:"", region:"Western", aggregate:15, status:"pending" },
  { id:5, full_name:"Yaw Darko", index:"2024005", class:"", region:"Volta", aggregate:10, status:"confirmed" },
];
...
export const ANNOUNCEMENTS = [
  { id:1, title:"BECE Registration Open", body:"Eligible students should complete BECE registration by April 30, 2024.", date:"2024-04-10", type:"urgent" },
...
export const TEACHERS_DATA = [
  { id:1, name:"Mr. Kwesi Adjei", subject:"Mathematics", class:"", phone:"0244123456" },
  { id:2, name:"Mrs. Ama Owusu", subject:"English Language", class:"", phone:"0244234567" },
  { id:3, name:"Mr. Baffour Dankwah", subject:"Science", class:"", phone:"0244345678" },
];
export const EVENTS_DATA = [
  { id:1, title:"BECE Mock Exams", date:"2024-04-22", type:"exam", desc:"Three-day mock examination for selected candidates" },
